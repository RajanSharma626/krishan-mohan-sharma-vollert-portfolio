...
<head>
    ...
    <title>Krishan Mohan Sharma</title>
...
<body class="template-color-1 spybody white-version" data-spy="scroll" data-target=".navbar-example2" data-offset="150">
                ...
                <div class="header-center">
                    <nav id="sideNav" class="mainmenu-nav navbar-example2 d-none d-xl-block onepagenav">
                        ...
                        <ul class="primary-menu nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="gallaries">Gallaries</a></li>
        ...
        <div class="inner">
            <div class="menu-top">
                <div class="menu-header">
                    ...
                    <div class="close-button">
                        <button class="close-menu-activation close"><i class="bi bi-x fs-5"></i></button>
                    </div>
                </div>
            ...
            <div class="content">
                <ul class="primary-menu nav nav-pills onepagenav">
                    ...
                    <li class="nav-item"><a class="nav-link smoth-animation" href="gallaries">Gallaries</a></li>
                    <li class="nav-item"><a class="nav-link smoth-animation" href="contact-us">Contact</a></li>
                        ...
                        <div class="order-2 order-lg-1 col-lg-7 mt_md--50 mt_sm--50 mt_lg--30">
                            <div class="content">
                                <div class="inner mb-5">
                                    <h1 class="title">Krishan<span> Mohan Sharma</span>
                                    </h1>
                                    <span class="subtitle fw-bold">Chief Operating Officer and Board Member</span>

                                    <div>
                                        <p class="description">Mr. Krishan is having over 30 years of experience in
                                            managing multinational corporations, business strategy, operations,projects,
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12">
                                        <div class="social-share-inner-left">
                                            ...
                                            <ul class="social-share d-flex liststyle">
                                                <li class="facebook"><a href="tel:+91 9650706373"><i
                                                            data-feather="phone"></i></a>
                                                </li>
                                                <li class="mail"><a href="mailto:kmsharma76@gmail.com"><i
                                                            data-feather="mail"></i></a>
                                                </li>
                                                <li class="linkedin"><a href="https://www.linkedin.com/in/kmsharma76"><i
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" data-aos-once="true"
                            class="image-area aos-init aos-animate">
                            <div class="thumbnail">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" data-aos-once="true"
                        class="col-lg-7 mt_sm--30 aos-init aos-animate">
                        <div class="contant">
                            <div class="section-title text-left">
                                <span class="subtitle">Who I'm</span>
                                <h2 class="title">About Me</h2>
                            </div>
                            <p class="discription">
                                I am a seasoned COO and board member with over 30 years of experience in strategy,
                                operations, and business development, driving sustainable growth and transforming
                                organizations across diverse industries. My expertise spans precast concrete, oil & gas,
                                pre-engineered buildings, infrastructure projects, and equipment manufacturing.
                            </p>
                            <p class="discription">
                                As a board advisor, I provide strategic insights that foster organizational excellence,
                                cultural transformation, business development, and brand value. I have led large teams,
                                managing 3000+ employees, and my approach is centered on realizing organizational vision
                                through people engagement and strategic alliances. I excel in driving business
                                turnarounds, market strategies, project management, contract negotiations, and
                        ...
                        <!-- <ul class="rn-nav-list nav nav-tabs" id="myTabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="education-tab" data-bs-toggle="tab" href="#education"
                                    role="tab" aria-controls="education" aria-selected="true">Career Milestones</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="professional-tab" data-bs-toggle="tab" href="#professional"
                                    role="tab" aria-controls="professional" aria-selected="false">Education &
                                    Training</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="experience-tab" data-bs-toggle="tab" href="#experience"
                                    role="tab" aria-controls="experience" aria-selected="false">Honors & Awards</a>
                            </li>
                        </ul> -->
                                ...
                                <div class="personal-experience-inner mt--40">
                                    <div class="row">
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>Master of Technology - Mechanical</h4>
                                                                    <span>University of Delhi (2023 - 2024)</span>
                                                                </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>Strategic Management Executive - IIM </h4>
                                                                    <span>University of Delhi (2023 - 2024)</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>Corporate Finance Accounting - IIM </h4>
                                                                    <span>University of Delhi (2023 - 2024)</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>Bachelor of Engineering – Mechanical </h4>
                                                                    <span>Charted Engineer Mechanical </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <div class="content">
                                                <span class="subtitle">2007 - 2010</span>
                                                <h4 class="maintitle">Training & Certifications</h4>
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4><b>PMP</b> - Project Management Professional
                                                                    </h4>
                                                                </div>
                                                                <!-- <div class="date-of-time">
                                                                    <span>4.30/5</span>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4><b>ASQ - CSSBB</b> - Certified Six Sigma Blackn
                                                                    </h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4><b>ASQ</b> - Certified Manager
                                                                        Quality, Organizational Excellence </h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4><b>AWS - CWI</b> : American Welding Society</h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4><b>ASNT - NDT</b>: UT, RT, DPT, MPI - Level II
                                                                    </h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4><b>Lead Auditor</b> : ISO 9001,14001,45001 </h4>
                                                                    <span>Charted Engineer Mechanical </span>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div class="rn-service-area rn-section-gap section-separator" id="features">
            <div class="container">
                ...
                <div class="row row--25 mt_md--10 mt_sm--10">
                            ...
                            <div class="inner">
                                <div class="yt-video">
                                    <iframe class="rounded" width="100%" height="315"
                                        src="https://www.youtube.com/embed/t4A3Vs98doo?si=_GaBKv1Y6hzti6xM"
                                        title="YouTube video player" frameborder="0"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div class="content px-2">
                                    <h4 class="title fs-3">kmsharma ppt 1</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true"
                        class="col-12 mt--50 mt_md--30 mt_sm--30 text-center">

                        <a href="/galleries" name="submit" class="rn-btn">
                            <span>VIEW MORE</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true"
                        ...
                        <div class="rn-blog" data-bs-toggle="modal" data-bs-target="#exampleModalCenters">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="javascript:void(0)">Title here</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="footer" class="rn-footer-area footer-style-2 rn-section-gapTop section-separator">
        <div class="container pb--80 pb_sm--40 plr_sm--20">
            <div class="row">
                <div class="col-xl-5 col-12 col-lg-5 col-md-6 col-sm-6 col-12">
                    <div class="logo-thumbnail">
                        <p class="fs-3">COO with 30+ years of experience in strategy, operations, and business
                            development, driving growth across diverse industries and focusing on sustainability and
                            profitability.</p>
                    </div>
                    <div class="social-icone-wrapper">
                        <ul class="social-share d-flex liststyle">
                            <li class="facebook"><a href="tel:+91 9650706373"><i data-feather="phone"></i></a>
                            </li>
                            <li class="mail"><a href="mailto:kmsharma76@gmail.com"><i data-feather="mail"></i></a>
                            </li>
                            <li class="linkedin"><a href="https://www.linkedin.com/in/kmsharma76"><i
                                        data-feather="linkedin"></i></a>
                            </li>
                    ...
                    <p class="fs-5">© 2024 Krishan Mohan Sharma. All rights reserved.</p>
                </div>
                ...
                <div class="col-sl-4 col-12 mt_sm--20 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="menu-wrapper">
                        <div class="menu-title">
                            <h6>Contact Us</h6>
                        </div>
                        <ul class="menu-footer">
                            <li><a href="tel:+91 9650706373"><i data-feather="phone"></i> +91 9650706373</a> </li>
                            <li><a class="" href="mailto:kmsharma76@gmail.com"><i data-feather="mail"></i>
                                    kmsharma76@gmail.com</a></li>
                            <li><a href="#"><i data-feather="map"></i> Greater Noida, India
                                </a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="copyright text-center py-2 section-separator">
            <p class=" fs-4"> Designed & Developed by <a class="primary-clr" target="_blank"
                    href="https://www.fiverr.com/users/rajansharma626/">Rajan Sharma.</a></p>
        </div>
    </div>
    <!-- End Footer Area -->
