...
<head>
    ...
    <title>Contact us - Krishan Mohan Sharma</title>
                ...
                <div class="header-center">
                    <nav id="sideNav" class="mainmenu-nav navbar-example2 d-none d-xl-block onepagenav">
                        ...
                        <ul class="primary-menu nav nav-pills">
                            ...
                            <li class="nav-item current"><a class="nav-link" href="gallaries">Gallaries</a></li>
        ...
        <div class="inner">
            ...
            <div class="content">
                <ul class="primary-menu nav nav-pills onepagenav">
                    ...
                    <li class="nav-item"><a class="nav-link smoth-animation" href="#features">Gallaries</a></li>
                    ...
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            ...
                            <div class="title-area">
                                <h4 class="title">Krishan Mohan Sharma</h4>
                                <span>COO</span>
                            </div>
                        ...
                        <div class="contact-form-wrapper">
                            <div class="introduce">
                                ...
                                <form class="rnt-contact-form rwt-dynamic-form row" id="contact-form" method="POST"
                                    ...
                                    <div class="col-lg-12">
                                        <button name="submit" type="submit" id="submit" class="rn-btn w-100">
            ...
            <div class="row">
                <div class="col-xl-5 col-12 col-lg-5 col-md-6 col-sm-6 col-12">
                    <div class="logo-thumbnail">
                        <p class="fs-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nisi officia sint aliquam quibusdam
                            harum voluptatibus corrupti saepe veniam deserunt exercitationem!</p>
                    </div>
