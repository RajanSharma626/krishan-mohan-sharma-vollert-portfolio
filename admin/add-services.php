...
if (isset($_GET['id']) && $_GET['id'] != '') {
    $id = $_GET['id'];
    $fetchSql = mysqli_query($conn, "SELECT * FROM `service` WHERE `id`= '$id'");
...
if (isset($_POST['addservices'])) {
    ...
    $sql = mysqli_query($conn, "INSERT INTO `service`(`img`, `heading`, `description`  ) VALUES ('$img','$heading','$desc')");
...
if (isset($_POST['updateservices'])) {
    ...
    if ($_FILES['img']['name'] != '') {
        ...
        $sql = mysqli_query($conn, "UPDATE `service` SET `img`='$img',`heading`='$heading',`description`='$desc' WHERE `id` = '$id'");
    } else {
        $sql = mysqli_query($conn, "UPDATE `service` SET `heading`='$heading',`description`='$desc' WHERE `id` = '$id'");
    }
    if ($sql) {
        header("Location: services");
    }
